...
describe('SnackShack', function() {
  ...
  it('returns preparation time', function() {
    expect(snackshack.buy(1)).toEqual("0:00 1 sandwich orders placed, start making sandwich 1\n1:00 serve sandwich 1")
  ...
  it('assumes an order of 1 unless specified', function() {
    expect(snackshack.buy()).toEqual("0:00 1 sandwich orders placed, start making sandwich 1\n1:00 serve sandwich 1")
  })
